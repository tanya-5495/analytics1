...
fitted(fit2) # preicted values for input price and promoton
omni$sales #actualsales 
residuals(fit2) # difference between actual and predicted
...
plot(fit2,4)  # tells outliers which affect model #outliers 100's and 0's
omni[c(11,14,15),]
